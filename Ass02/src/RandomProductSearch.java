...
public class RandomProductSearch extends JFrame {
    ...
    public RandomProductSearch() {
        super("Jay's Product Search System");
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            RandomProductSearch frame = new RandomProductSearch();
            frame.pack();
