...
public class RockPaperScissorsFrame extends JFrame {
    ...
    public RockPaperScissorsFrame() {
        setTitle("Jay's Rock Paper Scissors");
        setSize(600, 400);
    ...
    private void setComputerStrategy(String selectedStrategy) {
        switch (selectedStrategy) {
            case "Random":
                computerStrategy = new RandomStrat();
                break;
            case "Least Used":
                computerStrategy = new LeastUsedStrat(playerMoveCounts);
                break;
            case "Most Used":
                computerStrategy = new MostUsedStrat(playerMoveCounts);
                break;
            case "Last Used":
                computerStrategy = new LastUsedStrat(lastPlayerMove);
                break;
            case "Cheat":
