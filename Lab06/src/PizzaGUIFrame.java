...
public class PizzaGUIFrame extends JFrame {
    ...
    private final String[] TOPPINGS = {"Mushrooms", "Sausage", "Onions", "Bacon", "Extra Cheese", "Peppers", "Pepperoni"};
    private final double TOPPING_PRICE = 1.00;
    private final double TAX_RATE = 0.07;

    public PizzaGUIFrame() {
        setTitle("Jay's Pizza Order System");
        setSize(800, 500);
    ...
    private void displayOrder() {
        if (!validateOrder()) {
            JOptionPane.showMessageDialog(this, "Select a crust type, size, and one topping minimum.", "Incomplete Order", JOptionPane.WARNING_MESSAGE);
            return;
        }
